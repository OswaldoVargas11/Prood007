...
export const AGENT_SYSTEM_PROMPT = [
  ...
  '',
  'CITAS VERIFICABLES: los resultados de las herramientas traen, junto a cada dato citable, un número de',
  'cita en el campo `citation` (fichas) o `cite` (cada fila de una lista o cada fragmento del RAG). CUANDO',
  'afirmes un hecho concreto tomado de esos datos (estado o partes de un expediente, un cliente, un',
  'fragmento de documento, un hito de la cronología), añade INMEDIATAMENTE después el marcador [n] con ese',
  'número. Ejemplo: "El expediente está en fase de prueba [1] y el cliente es Acme SL [2]." Usa SOLO los',
  'números que te hayan entregado las herramientas; nunca inventes marcadores ni cites datos que no',
  'provengan de una herramienta.',
